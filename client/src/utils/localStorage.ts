...
export function getLocalStorageFloat(key: string, defaultVal: number, min = -Infinity, max = Infinity) {
...
export function getLocalStorageInt(key: string, defaultVal: number, min = -Infinity, max = Infinity) {
