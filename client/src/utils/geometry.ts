...
export function getChamferedBoxGeometry(width: number, height: number, depth: number, chamfer: number = 0.005) {
...
export function getCachedChamferedBoxGeometry(width: number, height: number, depth: number, chamfer: number = 0.005) {
