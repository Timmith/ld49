...
export function stopListeningToProperty(obj: any, propName: string, onChange: ChangeCallback) {
...
export function migrateLiveProperty(oldObj: any, newObj: any, propName: string) {
